...
$.fn.RecaptchaFacebox = function(options) {
    ...
    $(this).click(function() {
        ...
        if($('#RecaptchaFacebox').html() == null) {
            $('body').prepend('<div id="RecaptchaFacebox" style="display: none;"><p class="message">Please enter the text displayed in the box below, then submit.<br />This tool helps prevent blog comment spam.</p><p class="error">Your entry was incorrect. Please try again.</p><div id="recaptcha"></div><input class="button" type="button" value="submit" /></div>');
        }
